...
RGBELoader.prototype = Object.assign(Object.create(DataTextureLoader.prototype), {
  ...
  parse: function (buffer) {
    ...
    const fgets = function (buffer, lineLimit, consume) {
      ...
      let p = buffer.pos
      let i = -1; let len = 0; let s = ''; const chunkSize = 128
    ...
    const RGBE_ReadPixels_RLE = function (buffer, w, h) {
      let data_rgba; let offset; let pos; let count; let byteValue
      let scanline_buffer; let ptr; let ptr_end; let i; let l; let off; let isEncodedRun
      const scanline_width = w; let num_scanlines = h; let rgbeStart
