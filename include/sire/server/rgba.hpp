#ifndef SIRE_RGBA_HPP_
#define SIRE_RGBA_HPP_
#include <cmath>
...
class Rgba {
 public:
  ...
  const double* rgba() const { return value_; }
  double* rgba() { return value_; }
  ...
  //   // We want to be sure that value_ remains well-formed even if set()
  //   throws,
