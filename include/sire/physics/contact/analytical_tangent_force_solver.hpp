#ifndef SIRE_ANALYTICAL_TANGENT_FORCE_SOLVER_HPP_
#define SIRE_ANALYTICAL_TANGENT_FORCE_SOLVER_HPP_
...
namespace contact::analytical_tangent_force {
...
class SIRE_API AnalyticalTangentForceSolver : public ContactSolver {
 public:
  AnalyticalTangentForceSolver();
  virtual ~AnalyticalTangentForceSolver();
  SIRE_DECLARE_MOVE_CTOR(AnalyticalTangentForceSolver);
