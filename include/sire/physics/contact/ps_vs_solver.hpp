#ifndef SIRE_PS_VS_SOLVER_HPP_
#define SIRE_PS_VS_SOLVER_HPP_
...
namespace contact::ps_vs_solver {
...
class SIRE_API PsVsSolver : public ContactSolver {
 public:
  PsVsSolver();
  virtual ~PsVsSolver();
  SIRE_DECLARE_MOVE_CTOR(PsVsSolver);
