...
auto Integrator::dataLength() const -> aris::Size { return data_length_; };
auto Integrator::setDataLength(aris::Size data_length) -> void {
  data_length_ = data_length;
};
Integrator::Integrator(aris::Size data_length, double step_size)
    : step_size_(step_size), data_length_(data_length){};
ARIS_DEFINE_BIG_FOUR_CPP(Integrator);
RK4Integrator::RK4Integrator(aris::Size data_length, double step_size)
